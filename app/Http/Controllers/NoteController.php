...
class NoteController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        */
        ...
        // Create and save simultaneously using relationship
    ...
    {
        /* We can rewrite it using relationship
        ...
        */
        ...
        // Check User using relationship
        if (!$note->user->is(Auth::user())) {
            return abort(403);
        }

        // Query Note using uuid
    ...
    public function destroy(Note $note)
    {
        ...
        */
        ...
        return to_route('notes.index')->with('success', 'Note deleted to trash!');
    }
}
